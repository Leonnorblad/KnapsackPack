...
```{r}
# Non parallel
system.time(brute_force_knapsack(x = knapsack_objects[1:21,], W = 2000, parallel=FALSE))
# Parallel
system.time(brute_force_knapsack(x = knapsack_objects[1:21,], W = 2000, parallel=TRUE))
```
